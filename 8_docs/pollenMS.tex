...
\begin{itemize}
  \item colony-level bumblebee-floral networks (see \textcite{yeFloralResourcePartitioning2024}) -- but find some way to account for phenology
\end{itemize}
